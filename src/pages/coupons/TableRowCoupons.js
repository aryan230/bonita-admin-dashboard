...
export const TableRowCoupons = (props) => {
  ...
  const deleteBtnClick = async () => {
    if (window.confirm("Are you sure")) {
      ...
      fetch(`https://postman365.herokuapp.com/api/coupon/${props.users.key}`, {
        method: "DELETE",
      })
  ...
  return (
    ...
    >
      ...
      <TableCell align="right">
        <Chip label={props.users.code} color="success" size="small" />
      </TableCell>
      <TableCell align="right">{props.users.type}</TableCell>
      <TableCell align="right">
        <Link to={`/coupons/edit/${props.users.key}`} className="links">
